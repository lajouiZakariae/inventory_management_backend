...
final class ImageControllerTest extends TestCase
{
    ...
    public function index_behaves_as_expected(): void
    {
        ...
        $response->assertOk()
            ->assertJsonStructure(['*' => ['id', 'altText', 'url', 'productId']])
    ...
    public function show_behaves_as_expected(): void
    {
        ...
        $response->assertOk();
        $response->assertJsonStructure(['id', 'altText', 'url', 'productId']);
        $response->assertJson(function (AssertableJson $json) use ($image) {
            $json
                ->where('altText', $image->alt_text)
                ->where('productId', $image->product_id)
